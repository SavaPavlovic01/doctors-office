...
export class RegisterComponent implements OnInit {
  ...
  register(){
    ...
    this.userService.register(this.username,this.password,this.phone,this.mail,this.name,this.lastname,this.fileData,this.address).subscribe((data)=>{
      ...
      this.msgInfo=''
      this.msgInfo='Succesfully registered'
    })
